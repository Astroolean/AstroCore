...
public class HardCommand implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender == null) return false; // If sender is null, return false to indicate error.
        ...
        if (args.length == 0) {
            // Send your custom usage message first.
            sender.sendMessage(ChatColor.RED + "Usage: /hard [enable/disable]");
            
            // Return true to prevent Spigot from sending the default usage message from plugin.yml.
            return true;
        }
        ...
        if (args[0].equalsIgnoreCase("enable")) {
            ...
            enhanceExistingMobs();
            return true; // Return true to indicate successful execution of the command.
        ...
        // If the arguments are invalid, return false to trigger the default usage display from plugin.yml.
        return false;
    }
