...
public class RenameCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Check if the sender has permission for the "rename" command
        if (!sender.hasPermission("astrocore.rename")) {
            sender.sendMessage(ChatColor.RED + "You do not have permission.");
            return true;
        }

        // Check if the sender has permission for the "lore" command
        if (!sender.hasPermission("astrocore.lore")) {
            sender.sendMessage(ChatColor.RED + "You do not have permission.");
            return true;
        }
