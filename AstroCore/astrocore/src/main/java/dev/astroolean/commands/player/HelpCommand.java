...
public class HelpCommand implements CommandExecutor {
    ...
    private void showCommands(Player player, int page) {
        ...
        commands.add("/multibreak"); descriptions.add("Allows you to break 3x3x3 at a cost of 500 xp.");
        commands.add("/nickname"); descriptions.add("Give yourself a nickname of choice; costs experience.");
        commands.add("/whois"); descriptions.add("Find out who someone is.");
        commands.add("/show"); descriptions.add("Show off your numerous items and stuff.");

        commands.add("/clone"); descriptions.add("Why dupe when you can do it legally; costs experience...");
